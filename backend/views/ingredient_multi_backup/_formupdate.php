...
<div class="form">
    ...
    <div class="row">
        ...
        $this->widget(
            ...
            'name' => 'measures[]',
//            'data' => Ingredient::getmeasurementupdate($model->id),
            'data' => Ingredient::getmeasurementhere(),
            'value' => Ingredient::getmeasurementupdate($model->id),
            // 'value' => array('Measure1', 'Measure2'),
            'htmlOptions' => array(
                'multiple' => 'multiple',
                'class' => 'span3',
                'id' => 'select1li_id'
    ...
    <div class="row">
        <?php
//                echo $form->labelEx($model,'measure_unit');
//                echo $form->dropDownList($model,'measure_unit', $model->getWeightTypeOptions());
//                echo $form->error($model,'measure_unit');
//                
        ?>
    </div>

...
<div class="form">
    ...
    <div class="row">
        ...
        if ($model->status == 'Active') {
            ...
            echo $form->dropDownList($model, 'status', array('inactive' => 'Inactive', 'active' => 'Active'));
        }
//echo $form->dropDownList($model, 'status', array('inactive'=>'Inactive', 'active'=>'Active'));
        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('label:contains("Email ")').text("Username");
        // $('.ui-btn-text:contains("Jrvoinbraak")').text("RvO Inbraak");
    });

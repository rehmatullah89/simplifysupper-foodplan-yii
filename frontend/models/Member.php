...
class Member extends CActiveRecord {
    ...
    //firstname, username,about, photo, address, city, state, zip, phone, dob, age, signed_up, usertype, recipes, articles, photos, videos, testimonials, friends, viewed, spclicks, spviews, meta_keywords, meta_title, meta_desc
    public function rules() {
        // NOTE: you should only define rules for those attributes that
        // will receive user inputs.
        return array(
            array('password,email', 'required'),
            array('facebook_id, firstname, username , about, photo, address, city, state, zip, phone, dob, age, signed_up, usertype, recipes, articles, photos, videos, testimonials, friends, viewed, spclicks, spviews, meta_keywords, meta_title, meta_desc','required','on'=>array('create','update')),
            ...
            array('memberid, firstname, lastname, email, username, password, about, photo, address, city, state, zip, country, phone, dob, age, gender, status, signed_up, usertype, recipes, articles, photos, videos, testimonials, friends, viewed, spclicks, spviews, howto, meta_keywords, meta_title, meta_desc', 'safe', 'on' => array('join', 'search')),
        );
    }
